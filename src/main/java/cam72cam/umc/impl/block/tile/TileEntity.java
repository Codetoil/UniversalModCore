package cam72cam.umc.impl.block.tile;

import cam72cam.umc.impl.ModCore;
import cam72cam.umc.impl.block.BlockEntity;
import cam72cam.umc.impl.energy.IEnergy;
import cam72cam.umc.impl.entity.boundingbox.BoundingBox;
import cam72cam.umc.impl.entity.boundingbox.IBoundingBox;
import cam72cam.umc.impl.fluid.Fluid;
import cam72cam.umc.impl.fluid.ITank;
import cam72cam.umc.impl.item.IInventory;
import cam72cam.umc.impl.math.Vec3i;
import cam72cam.umc.impl.resource.Identifier;
import cam72cam.umc.impl.serialization.SerializationException;
import cam72cam.umc.impl.serialization.TagSerializer;
import cam72cam.umc.impl.util.Facing;
import cam72cam.umc.impl.serialization.TagCompound;
import cam72cam.umc.impl.util.SingleCache;
import cam72cam.umc.impl.world.World;
        ...
        if (capability == CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY) {
            ...
            return CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY.cast(new IFluidHandler() {
                ...
                public int fill(FluidStack resource, boolean doFill) {
                    int res = target.fill(new cam72cam.umc.impl.fluid.FluidStack(resource), !doFill);
                    return res;
                }
                ...
                public FluidStack drain(FluidStack resource, boolean doDrain) {
                    return target.drain(new cam72cam.umc.impl.fluid.FluidStack(resource), !doDrain).internal;
                }
                ...
                public FluidStack drain(int maxDrain, boolean doDrain) {
                    ...
                    return target.drain(new cam72cam.umc.impl.fluid.FluidStack(new FluidStack(target.getContents().internal, maxDrain)), !doDrain).internal;
                }
            });
        }
        if (capability == CapabilityItemHandler.ITEM_HANDLER_CAPABILITY) {
            ...
            return CapabilityItemHandler.ITEM_HANDLER_CAPABILITY.cast(new IItemHandlerModifiable() {
                ...
                public void setStackInSlot(int slot, @Nonnull ItemStack stack) {
                    target.set(slot, new cam72cam.umc.impl.item.ItemStack(stack));
                }
                ...
                public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate) {
                    return target.insert(slot, new cam72cam.umc.impl.item.ItemStack(stack), simulate).internal;
                }
