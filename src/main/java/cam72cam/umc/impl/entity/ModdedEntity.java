package cam72cam.umc.impl.entity;

import cam72cam.umc.impl.ModCore;
import cam72cam.umc.impl.entity.boundingbox.BoundingBox;
import cam72cam.umc.impl.entity.boundingbox.IBoundingBox;
import cam72cam.mod.entity.custom.*;
import cam72cam.umc.impl.entity.custom.*;
import cam72cam.umc.impl.entity.sync.TagSync;
import cam72cam.umc.impl.item.ClickResult;
import cam72cam.umc.impl.math.Vec3d;
import cam72cam.umc.impl.math.Vec3i;
import cam72cam.umc.impl.net.Packet;
import cam72cam.mod.serialization.*;
import cam72cam.umc.impl.serialization.*;
import cam72cam.umc.impl.util.SingleCache;
...
public class ModdedEntity extends Entity implements IEntityAdditionalSpawnData {
    ...
    public final void readSpawnData(ByteBuf additionalData) {
        if (cam72cam.umc.impl.world.World.get(world) == null) {
    ...
    public final boolean attackEntityFrom(DamageSource damagesource, float amount) {
        cam72cam.umc.impl.entity.Entity wrapEnt = damagesource.getTrueSource() != null ? self.getWorld().getEntity(damagesource.getTrueSource()) : null;
        DamageType type;
    ...
    private Vec3d calculatePassengerOffset(cam72cam.umc.impl.entity.Entity passenger) {
    ...
    public final void addPassenger(Entity entity) {
        if (!world.isRemote) {
            ...
            cam72cam.umc.impl.entity.Entity passenger = self.getWorld().getEntity(entity);
     ...
     */
    List<cam72cam.umc.impl.entity.Entity> getActualPassengers() {
        return seats.stream()
    ...
    void updateSeat(SeatEntity seat) {
        ...
        cam72cam.umc.impl.entity.Entity passenger = seat.getEntityPassenger();
    ...
    boolean isPassenger(cam72cam.umc.impl.entity.Entity passenger) {
        return getActualPassengers().stream().anyMatch(p -> p.getUUID().equals(passenger.getUUID()));
    }

    public void moveRiderTo(cam72cam.umc.impl.entity.Entity entity, CustomEntity other) {
    ...
    void removePassenger(cam72cam.umc.impl.entity.Entity passenger) {
        for (SeatEntity seat : this.seats) {
            cam72cam.umc.impl.entity.Entity seatPass = seat.getEntityPassenger();
    ...
    public static class PassengerPositionsPacket extends Packet {
        @TagField
        private cam72cam.umc.impl.entity.Entity target;
    ...
    public static class PassengerSeatPacket extends Packet {
        ...
        @TagField
        private cam72cam.umc.impl.entity.Entity rider;

        public PassengerSeatPacket() {}

        public PassengerSeatPacket(CustomEntity target, cam72cam.umc.impl.entity.Entity rider) {
            this.target = target;
            this.rider = rider;
        }
