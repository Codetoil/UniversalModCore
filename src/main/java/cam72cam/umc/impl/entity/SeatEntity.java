...
public class SeatEntity extends Entity implements IEntityAdditionalSpawnData {
    ...
    public void onUpdate() {
        ...
        if (getPassengers().isEmpty()) {
            if (this.ticks < 20) {
                if (!hasHadPassenger) {
                    cam72cam.umc.impl.entity.Entity toRide = World.get(world).getEntity(passenger, cam72cam.umc.impl.entity.Entity.class);
                    if (toRide != null) {
    ...
    public cam72cam.umc.impl.entity.Entity getParent() {
        cam72cam.umc.impl.entity.Entity linked = World.get(world).getEntity(parent, cam72cam.umc.impl.entity.Entity.class);
    ...
    public cam72cam.umc.impl.entity.Entity getEntityPassenger() {
        if (this.isDead) {
            return null;
        }
