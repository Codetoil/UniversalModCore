package cam72cam.umc.impl;

import cam72cam.umc.impl.config.ConfigFile;
import cam72cam.umc.impl.entity.ModdedEntity;
import cam72cam.umc.impl.entity.sync.EntitySync;
import cam72cam.umc.impl.event.ClientEvents;
import cam72cam.umc.impl.gui.GuiRegistry;
import cam72cam.umc.impl.input.Mouse;
import cam72cam.umc.impl.net.Packet;
import cam72cam.umc.impl.net.PacketDirection;
import cam72cam.umc.impl.render.BlockRender;
import cam72cam.umc.impl.render.Light;
import cam72cam.umc.impl.resource.BuiltinPack;
import cam72cam.umc.impl.resource.Identifier;
import cam72cam.umc.impl.text.Command;
import cam72cam.umc.impl.util.MinecraftFiles;
import cam72cam.umc.impl.util.ModCoreCommand;
import cam72cam.umc.impl.world.ChunkManager;
...
@net.minecraftforge.fml.common.Mod(modid = ModCore.MODID, name = ModCore.NAME, version = ModCore.VERSION, acceptedMinecraftVersions = "[1.12,1.13)", dependencies = "required-after:mixinbooter@[10.7,)")
