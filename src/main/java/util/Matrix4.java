...
//On top of that even more adjustments by Codetoil
public class Matrix4 {
    ...
    @SuppressWarnings("unused")
    protected Matrix4(double d00, double d01, double d02, double d03,
    ...
    @SuppressWarnings("unused")
    protected Matrix4(Facing facing) {
        this();
        setIdentity();
        translate(.5, .5, .5);
        switch (facing) {
    ...
    @NonNull
    private Matrix4 set(double n00, double n01, double n02, double n03, double n10, double n11, double n12, double n13, double n20, double n21, double n22, double n23, double n30, double n31, double n32, double n33) {
        m00 = n00;
        m01 = n01;
        m02 = n02;
        m03 = n03;
    ...
    public Matrix4 rotate(double angle, double x, double y, double z) {
        ...
        double f12 = yz * mc - xs;
        double f22 = z * z * mc + c;
        double d00 = m00 * f00 + m01 * f10 + m02 * f20;
        double d01 = m00 * f01 + m01 * f11 + m02 * f21;
        double d02 = m00 * f02 + m01 * f12 + m02 * f22;
        double d03 = m03;
        double d10 = m10 * f00 + m11 * f10 + m12 * f20;
        double d11 = m10 * f01 + m11 * f11 + m12 * f21;
        double d12 = m10 * f02 + m11 * f12 + m12 * f22;
        double d13 = m13;
        double d20 = m20 * f00 + m21 * f10 + m22 * f20;
        double d21 = m20 * f01 + m21 * f11 + m22 * f21;
        double d22 = m20 * f02 + m21 * f12 + m22 * f22;
        double d23 = m23;
        double d30 = m30 * f00 + m31 * f10 + m32 * f20;
        double d31 = m30 * f01 + m31 * f11 + m32 * f21;
        double d32 = m30 * f02 + m31 * f12 + m32 * f22;
        double d33 = m33;
        return set(d00, d01, d02, d03, d10, d11, d12, d13, d20, d21, d22, d23, d30, d31, d32, d33);
    }
    ...
    public Matrix4 leftMultiply(Matrix4 mat) {
        ...
        return set(n00, n01, n02, n03, n10, n11, n12, n13, n20, n21, n22, n23, n30, n31, n32, n33);
    }
    ...
    private Vector3f mult3x3(Vector3f vec) {
